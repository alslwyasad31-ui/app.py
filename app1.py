...
def v26_engine():
    try:
        data = request.json
        # ترجمة الوصف للإنجليزية لمحرك Pexels
        ...
        video = ""
        if v_res.get('videos') and len(v_res['videos']) > 0:
            video = v_res['videos'][0]['video_files'][0]['link']
...
if __name__ == '__main__':
    # مهم جداً لمنصة Render: قراءة المنفذ من متغيرات البيئة
